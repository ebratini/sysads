...
import com.instituto_jose_reyes.model.ejb.HorarioFacade;
import com.instituto_jose_reyes.model.entities.Horario;
    ...
    public static class HorarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Horario) {
                ...
                return getStringKey(o.getHroId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + HorarioController.class.getName());
            }
        }
    }
}
