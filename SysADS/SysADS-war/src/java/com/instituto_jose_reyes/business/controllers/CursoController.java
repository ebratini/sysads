...
import com.instituto_jose_reyes.model.ejb.CursoFacade;
    ...
    public static class CursoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Curso) {
                ...
                return getStringKey(o.getCsoId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CursoController.class.getName());
            }
        }
    }
}
