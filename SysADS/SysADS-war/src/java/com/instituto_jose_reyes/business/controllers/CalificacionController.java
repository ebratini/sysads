...
import com.instituto_jose_reyes.model.ejb.CalificacionFacade;
import com.instituto_jose_reyes.model.entities.Calificacion;
    ...
    public static class CalificacionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Calificacion) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CalificacionController.class.getName());
            }
        }
    }
}
