...
import com.instituto_jose_reyes.model.ejb.EstudianteFacade;
    ...
    public static class EstudianteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estudiante) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + EstudianteController.class.getName());
            }
        }
    }
}
